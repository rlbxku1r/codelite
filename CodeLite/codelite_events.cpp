...
wxDEFINE_EVENT(wxEVT_WORKSPACE_CLOSING, clWorkspaceEvent);

wxDEFINE_EVENT(wxEVT_WORKSPACE_CONFIG_CHANGED, wxCommandEvent);
wxDEFINE_EVENT(wxEVT_WORKSPACE_RENAMED, clCommandEvent);
...
wxDEFINE_EVENT(wxEVT_FILE_CREATED, clFileSystemEvent);
wxDEFINE_EVENT(wxEVT_FOLDER_CREATED, clFileSystemEvent);
wxDEFINE_EVENT(wxEVT_FILE_FIND_MATCHING_PAIR, clFileSystemEvent);
...
wxDEFINE_EVENT(wxEVT_PROGRAM_STARTED, clExecuteEvent);
wxDEFINE_EVENT(wxEVT_PROGRAM_TERMINATED, clExecuteEvent);
...
wxDEFINE_EVENT(wxEVT_STOP_BUILD, clBuildEvent);
...
wxDEFINE_EVENT(wxEVT_GET_IS_BUILD_IN_PROGRESS, clBuildEvent);
wxDEFINE_EVENT(wxEVT_BUILD_OUTPUT_HOTSPOT_CLICKED, clBuildEvent);
...
wxDEFINE_EVENT(wxEVT_DEBUG_SET_FILELINE, clDebugEvent);
wxDEFINE_EVENT(wxEVT_DEBUG_BREAKPOINTS_LIST, clDebugEvent);
wxDEFINE_EVENT(wxEVT_DEBUGGER_REFRESH_PANE, clDebugEvent);
wxDEFINE_EVENT(wxEVT_BREAKPOINTS_UPDATED, clDebugEvent);
wxDEFINE_EVENT(wxEVT_BREAKPOINTS_UI_UPDATED, clDebugEvent);
wxDEFINE_EVENT(wxEVT_BREAKPOINTS_UI_EDITOR_UPDATED, clDebugEvent);
wxDEFINE_EVENT(wxEVT_DEBUGGER_SET_MEMORY, clDebugEvent);
wxDEFINE_EVENT(wxEVT_QUICK_DEBUG, clDebugEvent);
wxDEFINE_EVENT(wxEVT_QUICK_DEBUG_DLG_SHOWING, clDebugEvent);
wxDEFINE_EVENT(wxEVT_QUICK_DEBUG_DLG_DISMISSED_OK, clDebugEvent);
...
wxDEFINE_EVENT(wxEVT_CC_SEMANTICS_HIGHLIGHT, clCodeCompletionEvent);
wxDEFINE_EVENT(wxEVT_CC_WORKSPACE_SYMBOLS, clCodeCompletionEvent);
...
wxDEFINE_EVENT(wxEVT_CC_FIND_HEADER_FILE, clCodeCompletionEvent);
wxDEFINE_EVENT(wxEVT_CC_FIND_SYMBOL_DECLARATION, clCodeCompletionEvent);
wxDEFINE_EVENT(wxEVT_CC_FIND_SYMBOL_DEFINITION, clCodeCompletionEvent);
...
wxDEFINE_EVENT(wxEVT_CC_BLOCK_COMMENT_CODE_COMPLETE, clCodeCompletionEvent);
wxDEFINE_EVENT(wxEVT_CC_BLOCK_COMMENT_WORD_COMPLETE, clCodeCompletionEvent);
wxDEFINE_EVENT(wxEVT_CMD_CREATE_NEW_WORKSPACE, clCommandEvent);
wxDEFINE_EVENT(wxEVT_CMD_OPEN_WORKSPACE, clCommandEvent);
wxDEFINE_EVENT(wxEVT_SWITCHING_TO_WORKSPACE, clCommandEvent);
...
wxDEFINE_EVENT(wxEVT_FINDINFILES_DLG_SHOWING, clFindInFilesEvent);
wxDEFINE_EVENT(wxEVT_FINDINFILES_DLG_DISMISSED, clFindInFilesEvent);
wxDEFINE_EVENT(wxEVT_FINDINFILES_OPEN_MATCH, clFindInFilesEvent);
...
wxDEFINE_EVENT(wxEVT_DBG_UI_DELETE_ALL_BREAKPOINTS, clDebugEvent);
...
wxDEFINE_EVENT(wxEVT_FILE_CLOSED, clCommandEvent);
...
wxDEFINE_EVENT(wxEVT_INFO_BAR_BUTTON, clCommandEvent);
wxDEFINE_EVENT(wxEVT_BUILD_CUSTOM_TARGETS_MENU_SHOWING, clContextMenuEvent);
wxDEFINE_EVENT(wxEVT_SOURCE_CONTROL_PUSHED, clSourceControlEvent);
